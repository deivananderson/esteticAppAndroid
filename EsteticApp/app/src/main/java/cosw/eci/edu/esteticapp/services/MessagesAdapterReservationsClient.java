...
public class MessagesAdapterReservationsClient extends RecyclerView.Adapter<MessagesAdapterReservationsClient.ViewHolder> {

    private final Context context;

    private List<Reservation> reservations = new ArrayList<>();

    public MessagesAdapterReservationsClient(Context context )
    {
